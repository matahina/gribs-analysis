...
date_var = paste(paste0(strsplit(commandArgs(trailingOnly = T)[3],"")[[1]][1:4], collapse = ""),
      paste0(strsplit(commandArgs(trailingOnly = T)[3],"")[[1]][5:6], collapse = ""),
      paste0(strsplit(commandArgs(trailingOnly = T)[3],"")[[1]][7:8], collapse = ""),
      sep ="-")
...
barwidth = c(rep(4, 56))
barwidth_gefs = c(rep(2, 63), rep(4, 24))
barwidth_ecmwf = c(rep(2, 45), rep(4, 33))
...
pp_unif <- pp_unif[-which(as.integer(format(as.POSIXct(pp_unif$variable),"%H"))  %in% seq(3,21,6)),]
...
pp_unif_orig$value[which(pp_unif_orig$value < 1)] <-
  round(pp_unif_orig$value[which(pp_unif_orig$value < 1)], 1)
pp_unif_orig$value[which(pp_unif_orig$value > 1)] <-
  round_any(pp_unif_orig$value[which(pp_unif_orig$value > 1)], 1)
pp_unif_orig$value[which(pp_unif_orig$value > 30)] <- 30
...
pp_props_gefs <-
  prop.table(table(pp_unif_orig[which(grepl("GEFS", pp_unif_orig$runs)), "variable"], pp_unif_orig[which(grepl("GEFS", pp_unif_orig$runs)), "value"]), margin =
               1)
...
if (length(the_dates) != length(pp_props_gefs[, 1])) {
  pp_probs_gefs[, 1] <-
    sort(unique(c(pp_unif_orig$variable[grepl("GEFS", pp_unif_orig$runs)])))
} else {
...
pp_props_ecmwf <-
  prop.table(table(pp_unif_orig[which(grepl("ECMWF", pp_unif_orig$runs)), "variable"], pp_unif_orig[which(grepl("ECMWF", pp_unif_orig$runs)), "value"]), margin =
               1)
...
if (length(the_dates) != length(pp_props_ecmwf[, 1])) {
  pp_probs_ecmwf[, 1] <-
    sort(unique(c(pp_unif_orig$variable[grepl("ECMWF", pp_unif_orig$runs)])))
} else {
  pp_probs_ecmwf[, 1] <- the_dates
}
...
pp_probs_all$V1 <- c(as_datetime(pp_probs_all$V1[1:56]) + hours(3))

pp_probs_gefs$V1 <- c(as_datetime(pp_probs_gefs$V1[1:63]) + minutes(90),as_datetime(pp_probs_gefs$V1[64:87]) + hours(3))

pp_probs_ecmwf$V1 <- c(as_datetime(pp_probs_ecmwf$V1[1:45]) + minutes(90),as_datetime(pp_probs_ecmwf$V1[46:78]) + hours(3))
