...
barwidth_ecmwf = c(rep(2, 40), rep(4, 36))
...
allruns <-
  merge(allruns,
        get_data(str_replace_all(date_var, "-", ""), "ecmwf"),
        all.x = TRUE,
        all.y = TRUE)
...
pp_unif_ecmwf <- pp_unif[which(grepl("ECMWF", pp_unif$runs)),]
...
pp_unif <- pp_unif[-which(as.POSIXct(pp_unif$variable) > as.POSIXct(date_var) + hours(144) & as.integer(format(as.POSIXct(pp_unif$variable),"%H"))  %in% seq(3,21,6)),]
...
pp_unif_ecmwf <- pp_unif_ecmwf[order(pp_unif_ecmwf$runs),]

for (i in seq(1,nrow(pp_unif_ecmwf))){
    if (as.POSIXct(pp_unif_ecmwf$variable[i]) > as.POSIXct(date_var) + hours(144)) {
      if (as.integer(format(as.POSIXct(pp_unif_ecmwf$variable[i]),"%H"))  %in% seq(3,21,6) ) {
        pp_unif_ecmwf$value[i-1] = pp_unif_ecmwf$value[i-1] + pp_unif_ecmwf$value[i] 
      }
    }
}

pp_unif_ecmwf <- pp_unif_ecmwf[-which(as.POSIXct(pp_unif_ecmwf$variable) > as.POSIXct(date_var) + hours(144) & as.integer(format(as.POSIXct(pp_unif_ecmwf$variable),"%H"))  %in% seq(3,21,6)),]
...
pp_unif_ecmwf$value[which(pp_unif_ecmwf$value < 1)] <-
  round(pp_unif_ecmwf$value[which(pp_unif_ecmwf$value < 1)], 1)
pp_unif_ecmwf$value[which(pp_unif_ecmwf$value > 1)] <-
  round_any(pp_unif_ecmwf$value[which(pp_unif_ecmwf$value > 1)], 1)
pp_unif_ecmwf$value[which(pp_unif_ecmwf$value > 30)] <- 30
...
pp_props_ecmwf <-
  prop.table(table(pp_unif_ecmwf$variable, pp_unif_ecmwf$value), margin =
               1)

pp_props_ecmwf[which(is.na(pp_props_ecmwf))] = 0

manquants <-
  maps_limits[which(is.na(match(maps_limits, colnames(pp_props_ecmwf))))]
if (length(manquants  > 0)) {
  for (var in manquants) {
    pp_props_ecmwf <- cbind(pp_props_ecmwf, rep(0, nrow(pp_props_ecmwf)))
    colnames(pp_props_ecmwf)[length(colnames(pp_props_ecmwf))] <- var
  }
  
}
pp_props_ecmwf <- pp_props_ecmwf[, as.character(maps_limits)]


pp_probs_ecmwf = t(apply(pp_props_ecmwf, 1, revcumsum))
colnames(pp_probs_ecmwf) <- colnames(pp_props_ecmwf)
pp_probs_ecmwf <- as.data.frame.matrix(pp_probs_ecmwf)
pp_probs_ecmwf[, 1] <- row.names(pp_probs_ecmwf)
pp_probs_ecmwf <- pp_probs_ecmwf[, as.character(maps_limits)]
names(pp_probs_ecmwf) <- paste(rep("V", 110), seq(1, 110), sep = "")
...
pp_probs_ecmwf <-
  pp_probs_ecmwf[which(row.names(pp_probs_ecmwf) >= the_dates[1]), ]
pp_probs_ecmwf <-
  pp_probs_ecmwf[which(row.names(pp_probs_ecmwf) <= the_dates[length(the_dates)]),]
...
pp_probs_all$V1 <- c(as_datetime(pp_probs_ecmwf$V1[1:40]) + minutes(90),as_datetime(pp_probs_ecmwf$V1[41:76]) + hours(3))

pp_probs_gefs$V1 <- c(as_datetime(pp_probs_gefs$V1[1:56]) + minutes(90),as_datetime(pp_probs_gefs$V1[57:84]) + hours(3))

pp_probs_ecmwf$V1 <- c(as_datetime(pp_probs_ecmwf$V1[1:40]) + minutes(90),as_datetime(pp_probs_ecmwf$V1[41:76]) + hours(3))

pp_probs_all$V1 <- as.POSIXct(pp_probs_all$V1, tz="UTC")
pp_probs_gefs$V1 <- as.POSIXct(pp_probs_gefs$V1, tz="UTC")
pp_probs_ecmwf$V1 <- as.POSIXct(pp_probs_ecmwf$V1, tz="UTC")
...
plot_z500all <-
  ...
  scale_y_continuous(
    ...
    "Z500 _ ENS GEFS 00z06z12z18z GEM 00z12z FNMOC 00z12z ECMWF 00z12z  %s",
    date_var
  )) +
...
plot_z500ecmwf <-
  ggplot(plotruns[which(grepl("ECMWF", plotruns$runs)),], aes(dates, geop)) + geom_count(aes(
    size = ..prop..,
    alpha = ..prop..,
    colour = geop
  )) +
  ...
  ) + ggtitle(sprintf("Z500 _ ENS ECMWF 00z12z  %s", date_var)) +
geom_line(data = norms_profile [ (norms_profile$date >= the_dates [1]) & (norms_profile$date < (the_dates [1] +days(15)) )
                                                  & norms_profile$type == "hgt",],
                           aes(x = date, y = value, group = 1),
                           color = "gray")
...
plot_t850all <-
  ...
  scale_y_continuous(
    ...
    "T850 + PP _ ENS GEFS 00z06z12z18z GEM 00z12z FNMOC 00z12z ECMWF 00z12z  %s",
    date_var
  ))
idx <- 110
...
plot_t850ecmwf <-
  ggplot(plotruns[which(grepl("ECMWF", plotruns$runs)), ], aes(dates, tempalt)) + theme_linedraw() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"),
    axis.title = element_blank(),
    legend.position = "none",
    panel.background = element_rect(
  ...
  ) + ggtitle(sprintf("T850 + PP _ ENS ECMWF 00z12z  %s", date_var))

idx <- 110
for (precip in rev(c(seq(0.1, 0.9, 0.1), seq(1, 100)))) {
  plot_t850ecmwf <- plot_t850ecmwf +
    geom_segment(
      data = pp_probs_ecmwf,
      aes_string(
        x = "V1",
      ...
      size = barwidth_ecmwf,
      color = MixColor("black", "cornflowerblue", 1 - pp_probs_ecmwf[, idx]),
      lineend = "butt"
    )
  idx <- idx - 1
}
...
plot_t2mall <-
  ...
  scale_y_continuous(
    ...
    "T2M + PP _ ENS GEFS 00z06z12z18z GEM 00z12z FNMOC 00z12z ECMWF 00z12z  %s",
    date_var
  ))
idx <- 110
for (precip in rev(c(seq(0.1, 0.9, 0.1), seq(1, 100)))) {
...
plot_t2mecmwf <-
  ggplot(plotruns[which(grepl("ECMWF", plotruns$runs)), ], aes(dates, tempsol)) + theme_linedraw() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"),
    axis.title = element_blank(),
    legend.position = "none",
    panel.background = element_rect(
...
# z500/t850 {data-navmenu="Diagrammes Probabilistes ALL-GEFS"}

## GEFS - GEM - FNMOC - ECMWF

### GEFS - GEM - FNMOC - ECMWF > z500

```{r plot1_36, fig.width=10, fig.height=5}

plot_z500all
```

### GEFS - GEM - FNMOC - ECMWF > t850 + PP

```{r plot2_36, fig.width=10, fig.height=5}
...
```{r plot3_36, fig.width=10, fig.height=5}
...
```{r plot4_36, fig.width=10, fig.height=5}
...
# t850/t2m {data-navmenu="Diagrammes Probabilistes ALL-GEFS"}

## GEFS - GEM - FNMOC - ECMWF

### GEFS - GEM - FNMOC - ECMWF > t850 + PP

```{r plot5_36, fig.width=10, fig.height=5}

plot_t850all
```

### GEFS - GEM - FNMOC - ECMWF > t2m + PP

```{r plot6_36, fig.width=10, fig.height=5}
...
```{r plot7_36, fig.width=10, fig.height=5}
...
```{r plot8_36, fig.width=10, fig.height=5}
...
# z500/t2m {data-navmenu="Diagrammes Probabilistes ALL-GEFS"}

## GEFS - GEM - FNMOC - ECMWF

### GEFS - GEM - FNMOC - ECMWF > z500

```{r plot9_36, fig.width=10, fig.height=5}
...
```{r plot10_36, fig.width=10, fig.height=5}
...
```{r plot11_36, fig.width=10, fig.height=5}
...
```{r plot12_36, fig.width=10, fig.height=5}
...
# z500/t850 {data-navmenu="ALL-ECMWF"}

## GEFS - GEM - FNMOC - ECMWF

### GEFS - GEM - FNMOC - ECMWF > z500

```{r plot13_36, fig.width=10, fig.height=5}
...
```{r plot14_36, fig.width=10, fig.height=5}
...
```{r plot15_36, fig.width=10, fig.height=5}
...
```{r plot16_36, fig.width=10, fig.height=5}
...
# t850/t2m {data-navmenu="ALL-ECMWF"}

## GEFS - GEM - FNMOC - ECMWF

### GEFS - GEM - FNMOC - ECMWF > t850 + PP

```{r plot17_36, fig.width=10, fig.height=5}
...
```{r plot18_36, fig.width=10, fig.height=5}
...
```{r plot19_36, fig.width=10, fig.height=5}
...
```{r plot20_36, fig.width=10, fig.height=5}
...
# z500/t2m {data-navmenu="ALL-ECMWF"}

## GEFS - GEM - FNMOC - ECMWF

### GEFS - GEM - FNMOC - ECMWF > z500

```{r plot21_36, fig.width=10, fig.height=5}
...
```{r plot22_36, fig.width=10, fig.height=5}
...
```{r plot23_36, fig.width=10, fig.height=5}
...
```{r plot24_36, fig.width=10, fig.height=5}
...
# z500/t850 {data-navmenu="GEFS-ECMWF"}

## GEFS

### GEFS > z500

```{r plot25_36, fig.width=10, fig.height=5}
...
```{r plot26_36, fig.width=10, fig.height=5}
...
```{r plot27_36, fig.width=10, fig.height=5}
...
```{r plot28_36, fig.width=10, fig.height=5}
...
# t850/t2m {data-navmenu="GEFS-ECMWF"}

## GEFS

### GEFS > t850 + PP

```{r plot29_36, fig.width=10, fig.height=5}
...
```{r plot30_36, fig.width=10, fig.height=5}
...
```{r plot31_36, fig.width=10, fig.height=5}
...
```{r plot32_36, fig.width=10, fig.height=5}
...
# z500/t2m {data-navmenu="GEFS-ECMWF"}

## GEFS

### GEFS > z500

```{r plot33_36, fig.width=10, fig.height=5}
...
```{r plot34_36, fig.width=10, fig.height=5}
...
```{r plot35_36, fig.width=10, fig.height=5}
...
```{r plot36_36, fig.width=10, fig.height=5}
...
pdf(sprintf("../../data/ecmwf/ens_unif-%s_%s.pdf",str_replace_all(date_var, "-", ""),prof_name),height=18,width=16)
grid.arrange(plot_z500all,plot_z500ecmwf,plot_t850all,plot_t850ecmwf,plot_t2mall,plot_t2mecmwf)
dev.off()
```
  ...
  
{
  ...
  for (i in seq(2, 8)) {
    ...
    ze <- c(
      ...
      paste(rep(sprintf(
        "ECMWF %s sc", format(date_var + hours(0), "%Y-%m-%d %H:%M:%S")
      ...
      paste(rep(sprintf(
        "ECMWF %s sc", format(date_var + hours(6), "%Y-%m-%d %H:%M:%S")
      )), str_pad(seq(1, 50), 2, pad = "0"), sep = ""),
      paste(rep(sprintf(
      ...
      paste(rep(sprintf(
        "ECMWF %s sc", format(date_var + hours(12), "%Y-%m-%d %H:%M:%S")
      )), str_pad(seq(1, 50), 2, pad = "0"), sep = ""),
      paste(rep(sprintf(
      ...
      paste(rep(sprintf(
        "ECMWF %s sc", format(date_var + hours(18), "%Y-%m-%d %H:%M:%S")
      )), str_pad(seq(1, 50), 2, pad = "0"), sep = ""),
      paste(rep(sprintf(
    ...
    b <-
      ggplot(map[which(str_detect(map[, 1], "ECMWF")), ], aes(x = 1, y = rev(SCENS))) +
      geom_tile(aes(fill = CLUST)) + theme_linedraw() + theme(
        panel.grid.major = element_blank(),
        plot.title = element_text(hjust = 0.5, face = "bold"),
        axis.title = element_blank(),
      ...
      scale_fill_manual(
        ...
        name = "Clusters"
                                                                                  ...
                                                                                  rev(ze_s[which(str_detect(map[, 1], "ECMWF"))])) + ggtitle("ECMWF")
