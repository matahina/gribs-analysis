...
if model_name == "ecmwf":
    ...
    step_z = 12
    last_sc = 50
    the_range = list(range(3,144,3))+list(range(144,366,6))
    ...
    case "ecmwf":
        for z in range(0, last_z+1, step_z):
            ...
            for ech in the_range:
                print("ech: "+str(ech))
                grbfile = "../../data/ecmwf/%s%02ddata_hgt_%s%02d.grib2" % (model_date, z, ech)
                extract_a = pd.DataFrame({'runs': [], 'dates': [], 'profile': [], 'geop': []})
                ...
                grbfile = "../../data/ecmwf/%s%02ddata_talt_%s%02d.grib2" % (model_date, z, ech)
                extract_b = pd.DataFrame({'runs': [], 'dates': [], 'profile': [], 'tempalt': []})
                ...
                grbfile = "../../data/ecmwf/%s%02ddata_tsolpp_%s%02d.grib2" % (model_date, z, ech)
